...
define(function (require) {
    ...
    Notebook.prototype.load_notebook_success = function (data) {
        ...
        // heart_beat interval: 2 minutes
        this.setup_heart_beat(2 * 60 * 1000);
    ...
    Notebook.prototype.setup_heart_beat = function(interval) {
        if (this.heart_beat_timer) {
            return;
        }
        var that = this;
        this.heart_beat_timer = setInterval(function() {
            if (that.session) {
                that.session.heart_beat();
            }
        }, interval);
    };
